...
@Component({
  selector: 'app-upload',
  standalone: true,
  imports: [CommonModule, IonContent, IonHeader, IonToolbar, IonTitle, IonButtons, IonBackButton, IonCard, IonCardContent, IonButton, IonIcon, IonProgressBar, IonText],
  template: `
    <ion-header>
    ...
    <ion-content class="ion-padding">
      <div class="container" style="max-width: 600px;">
        ...
        <ion-card class="text-center p-4">
          <ion-icon name="cloud-upload-outline" style="font-size: 64px;" color="primary"></ion-icon>
